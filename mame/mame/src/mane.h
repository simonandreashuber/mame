...
private:
	...
	bool m_sn_soe_int(unsigned long long int sn_index, const unsigned long long int& integer) const;//tested range: sn_index < m_s0.size(), max(integer, m_s0)
	...
	unsigned long long int m_mod(unsigned long long int n, const unsigned long long int& y) const;
